          ...
          <form onSubmit={onSubmitHandler} className="space-y-5">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="pl-12 pr-12 py-3 w-full rounded-md border border-gray-300 bg-white text-gray-800 focus:ring-2 focus:ring-blue-500 outline-none placeholder-gray-500"
              />
              <div
